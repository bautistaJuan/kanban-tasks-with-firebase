...
const BoardInterface = ({ boardData, boardId, updateLastUpdated }) => {
  ...
  const handleOpenShiftTaskModal = useCallback(task => setShiftTask(task), []);
  ...
  const handleAddTask = async text => {
    if (!text.trim()) return setToastr("La tarea no puede estar vacia!");
    const dClone = structuredClone(tabs);
